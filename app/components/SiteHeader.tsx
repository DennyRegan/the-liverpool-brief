      ...
      <div className="site-width">
        ...
        <div className="header-bottom">
          ...
          <nav aria-label="Main navigation">
            {([{ href: "/", label: "Home", key: "home" }, { href: "/brief", label: "Brief", key: "brief" }, { href: "/articles", label: "Articles", key: "articles" }, { href: "/this-week", label: "This Week", key: "this-week" }, { href: "/about", label: "About", key: "about" }] as const).map(item => (
