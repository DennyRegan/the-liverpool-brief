...
await ready('#shootout-5');await page.locator('#half-time').evaluate(e=>window.scrollTo(0,window.scrollY+e.getBoundingClientRect().top-90));await page.waitForFunction(()=>location.hash==='#half-time');
