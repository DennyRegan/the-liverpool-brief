---
title: "Liverpool 5–0 Nottingham Forest: five goals at Anfield"
historicalEventDate: "1988-04-13"
historicalPeriod: "13 April 1988 · First Division · Anfield"
decade: "1980s"
excerpt: "John Aldridge scored twice and John Barnes helped create two goals as Liverpool beat Forest for the second time in five days."
slug: "liverpool-nottingham-forest-1988-five-at-anfield"
category: "match"
articleType: "match"
season: "1987-88"
...
Forest had beaten Liverpool at the City Ground eleven days earlier. This third meeting in less than a fortnight developed very differently, with Steve Sutton repeatedly preventing the score from becoming heavier.

Houghton opened the scoring after eighteen minutes. Alan Hansen began the move with an interception, Houghton advanced through the middle and exchanged passes with John Barnes before finishing. Beardsley's through-ball then sent Aldridge clear to lift Liverpool's second over Sutton before half-time.

Sutton also turned a Beardsley shot against the bar. Alan Green's contemporary BBC World Service report recorded two Liverpool efforts against the woodwork and three major saves before the interval: the 2–0 lead represented only part of the pressure Forest had faced.
...
- [LFChistory — match record and table](https://www.lfchistory.net/games/1632)
- [11v11 — independent result, scorers and attendance](https://www.11v11.com/matches/liverpool-v-nottingham-forest-13-april-1988-88929/)
- [The Times — contemporary report, archived transcription](https://www.lfchistory.net/images/newspapers/riley/19880413vnottmf.pdf)
- [Brian Pead, Complete Record — match account reproduced by LFChistory](https://www.lfchistory.net/articles/439)
- [Alan Green — BBC World Service report transcription](https://www.lfchistory.net/articles/706)
- [Liverpool FC — retrospective and league context](https://www.liverpoolfc.com/news/classic-match-dalglishs-reds-peak-perfect-anfield-performance)

## EDITOR NOTES

Classic179. Actual model `gpt-6-astra`; worker `/root/astra_c`. Coordinator confirmed main246fc2d claim, token01a0a524-classic-179. Fresh retrieval and self-review15 September2026. No publication date; shared records coordinator-owned.
...
Independent review15 September2026 — actual model `gpt-6-astra`, reviewer `/root/astra_b`: Fresh full Times transcription and Alan Green BBC account retrieved and checked for goal development, Walker substitution and the explicitly attributed first-half saves/woodwork assessment. LF1632 table re-retrieved:80/34, United69/36 and Forest63/34 validate the points gaps and remaining fixtures. No correction needed. Source scopes and combined newspaper word allowances reviewed; no footage viewed. Stable after this bounded factual and prose review.
