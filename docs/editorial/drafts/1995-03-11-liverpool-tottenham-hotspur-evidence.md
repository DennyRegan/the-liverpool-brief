# Editorial evidence: 11 March 1995

Unpublished factual draft. Configured model gpt-6-astra; worker /root/astra_1994_95. Remote claim confirmed before drafting; no footage viewed, quotation or publication date.
...
- Initial suggested date12March corrected to11March before calendar claim. FA primary and match record agree.
- FA describes winner lifted over James; contemporary report angled right-foot shot. Public copy simply says finish beat James, common verified fact; no invented exact technique.
- Sheringham goal recorded45 but report describes first-half added time. Use before interval without an exact elapsed timestamp.
- Defeat selected for importance to season's cup ambitions, not as a Liverpool performance superlative.
- All included entity IDs existing; no speculative new opposition-player IDs.
